...
export class CategoriaComponent implements OnInit {
  ...
  constructor(private sucursalServicio:SucursalService, private categoriaServicio:CategoriaService, private route:Router,private toastr: ToastrService,private dialog:MatDialog,public dialogo: MatDialog) {}
  ngOnInit(): void {
